  ...
  config:
    toggles:
      ...
      properties:
        ...
        runInsertedText:
          ...
          description: 'Run text inserted via `atom-macaulay2:insert-text` as a command? **This will append an end-of-line character to input.**'
          type: 'boolean'
          default: true
        selectToCopy:
    ...
    customTexts:
      ...
      properties:
        customText1:
          title: 'Custom text 1'
          description: 'Text to paste when calling atom-macaulay2:insert-custom-text-1, $S is replaced by selection, $F is replaced by file name, $D is replaced by file directory, $L is replaced by line number of cursor, $$ is replaced by $'
          type: 'string'
          default: ''
        customText2:
          title: 'Custom text 2'
          description: 'Text to paste when calling atom-macaulay2:insert-custom-text-2'
          type: 'string'
          default: ''
